    ...
    return {
        ...
        plugins: [
            ...
            new webpack.DefinePlugin({
                ...
                'APP_NAME': JSON.stringify('Interr')
            }),
    ...
    return {
        ...
        setupMiddlewares: (middlewares, devServer) => {
            devServer.app.use((req, res, next) => {
                if (req.url === '/' && !req._headersSent) {
                    console.log('\n═════════════════════════════════════════');
                    console.log('INTERR Dev Server is running at:');
                    console.log('═════════════════════════════════════════');
                    console.log('Loopback: http://localhost:8080/');
                    console.log('Network (IPv4): http://10.5.5.167:8080/');
                    console.log('');
