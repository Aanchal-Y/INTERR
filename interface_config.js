...
var interfaceConfig = {
    ...
    /**
     * Whether the mobile app is to be promoted to participants
    ...
    */
    ...
    // Remove/hide logos and welcome-page promo
    ...
    // Ensure any mobile-app promo flags are disabled (if used)
    SHOW_WELCOME_PAGE_MOBILE_APP_PROMO: false,
    ENABLE_MOBILE_APP_PROMO: false,
