# <p align="center">Interr React Native SDK</p>
...
If you want to test all the steps before applying them to your app, you can check the React Native SDK sample app.
...
```javascript
  <JitsiMeeting
    ...
    serverURL = { 'https://your-interr-server.example.com/' }
...
For more details on how you can use the React Native SDK, see the documentation in this repository.
