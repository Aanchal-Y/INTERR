Interr - redux state persistence
====================================
Interr has a persistence layer that persists specific subtrees of the redux
...
When it's done, Interr will automatically persist these subtrees and
